...
hymn-picker/
├─ public/data/
│  ├─ hymns.json            # 詩歌主資料（目前 44 首，已對照 hymnal.net 校正）
...
`hymns.json` 目前的 44 首，標題、第一句、調號、拍號、韻律、有無副歌、英文號與 `notes` 裡的
摘句、作者資料，都是直接從 <https://www.hymnal.net> 對應頁面抄下來的（前 27 首 2026-09-06，第三批 17 首 2026-09-12）。
